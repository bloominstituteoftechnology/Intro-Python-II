...
# Lists are mutable, sets hold distinct values, key:value for dictionary, dict order doesn't matter
...
s_names = [i.capitalize() for i in names if i.startswith('s') or i.startswith('S')]
