...
# * ROOMS
    ...
    room = {
        ...
        'foyer':    Room("Foyer", """Dim light filters in from the south. Dusty passages run north and east.""", [items['bottle'], items['cake'], items['key']]),
...
# * PLAYERS
    ...
    print(player)
    # print(textwrap.fill(player, width=50))
