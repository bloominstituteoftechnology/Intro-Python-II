...
while True:
    ...
    if move == 'n' and room_key == 'outside':
        room_key = room[player.current_room].n_to
        room_name = room[player.current_room].n_to.name
        room_desc = room[player.current_room].n_to.description
    elif move == 'q':
