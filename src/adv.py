...
new_player = Player(player_name = "Gio", current_room = room['outside'])
print("\nWelcome player! You may enter ")
...
print(f"{new_player.player_name} is in the{new_player.current_room} \n")
