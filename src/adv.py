...
while True:
    ...
    userInput = input("Choose a direction in which to move: n, s, e, w")
    ...
    # If the user enters "q", quit the game.
        ...
        print("Quitters never prosper!")
        break
    else:
    # Print an error message if the movement isn't allowed.
        print("Whoa partner! Cannot move there. Try again.")
        continue