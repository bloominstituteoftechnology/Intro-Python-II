...
while True:
    ...
    print(f"You currently reside in the {new_player.current_room.name}")
    ...
    if command == 'n':
        try:
            new_player = Player("Daniel", new_player.current_room.n_to)
            print(f"You move north and enter the {new_player.current_room.name}")
        except:
    ...
    if command == 's':
        try:
            new_player = Player("Daniel", new_player.current_room.s_to)
            print(f"You move north and enter the {new_player.current_room.name}")
        except:
            print("You have run into a dead end. try selecting a different direction.")
    ...
    if command == 'e':
        try:
            new_player = Player("Daniel", new_player.current_room.e_to)
            print(f"You move north and enter the {new_player.current_room.name}")
        except:
            print("You have run into a dead end. try selecting a different direction.")
    ...
    if command == 'w':
        try:
            new_player = Player("Daniel", new_player.current_room.w_to)
            print(f"You move north and enter the {new_player.current_room.name}")
        except:
            print("You have run into a dead end. try selecting a different direction.")
