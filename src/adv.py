...
def adventure_awaits():
    ...
    while (playing):
        ...
        input("Press or Enter Anything to Continue...\n -->  ")
        print("----------------------------")
        print("----------------------------")
        ...
        if (action == help):
            return "Enter direction i.e. 'n' for north, 's' for south, 'e' for east, 'w' for west. \ntype 'q' to quit \n"
            ...
            print("Please enter a direction: n, s, e, w. etc.")
